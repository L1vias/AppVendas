...
namespace AppVendas.Controllers
{
    public class ItemDaVendasController : Controller
    {
        ...
        {
            var applicationDbContext = _context.ItemDaVendas.Include(i => i.Produto).Include(i => i.Venda);
        ...
        public async Task<IActionResult> Create([Bind("ItemDaVendaId,VendaId,ProdutoId,QtdadeVenda,ValorTotalDoItem")] ItemDaVenda itemDaVenda)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("ItemDaVendaId,VendaId,ProdutoId,QtdadeVenda,ValorTotalDoItem")] ItemDaVenda itemDaVenda)
        {
